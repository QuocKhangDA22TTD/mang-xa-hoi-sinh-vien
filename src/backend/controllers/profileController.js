...
exports.createProfile = async (req, res) => {
  ...
  try {
    ...
    await profileModel.createProfile(user_id, full_name, bio, avatar_url, nickname, birthday, address);
...
exports.updateProfile = async (req, res) => {
  ...
  try {
    ...
    await profileModel.updateProfile(user_id, full_name, bio, avatar_url, nickname, birthday, address);
