 ...
 *     description: Upload and set user banner image
 *     requestBody:
 *       required: true
 *       content:
 *         multipart/form-data:
 ...
 *                 url:
 *                   type: string
 *                   example: https://daring-embrace-production.up.railway.app/uploads/1234567890-123456789.jpg
 *       400:
 *         description: No file uploaded
 *         content:
 *           application/json:
 ...
 *     description: Create a new chat conversation (1-on-1 or group)
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *                 type: string
 *                 example: Nhóm chat
 *                 description: Group name (required if is_group is true)
 *     responses:
 *       201:
