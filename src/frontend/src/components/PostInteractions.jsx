...
const PostInteractions = ({ postId }) => {
  ...
  const handleLikeToggle = async () => {
    ...
    try {
      ...
      console.log(`✅ Like toggle result:`, {
        liked: result.liked,
      ...
      if (updateLikeCount) {
        console.log(`🔄 Calling updateLikeCount with:`, {
          postId,
          likeCount: result.likeCount,
      ...
      // Additional force update after 500ms
      setTimeout(() => {
        console.log('🔄 Additional force reload...');
        loadPostInteractions(postId);
          ...
          <div className="max-h-96 overflow-y-auto">
            {interactions.comments.data.length === 0 ? (
              ...
              interactions.comments.data.map((comment) => (
                <div
                  key={comment.id}
                  className="flex gap-3 mb-4 p-3 bg-gray-50 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-300"
                >
                  <img
